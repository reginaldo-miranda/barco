        ...
        $(".ncredito").on('blur', function(){
         ...
         $(".pagar").on("click" , function(){
            ...
            PagSeguroDirectPayment.createCardToken({
                ...
                success : function(response){
                    alert("token da transacao recuperado com sucesso ")
                    console.log(response)
    ...
    @endif
        ...
        <div class ="row">
            ...
            <div class="col-4">
             ...
             <div class="col-4">
                Bandeira:
                <input type="text" name="bandeira" value="visa" class="bandeira form-control" />
            </div>
...
https://pt.stackoverflow.com/questions/59546/problema-entre-pagseguro-e-n%C3%BAmero-de-parcelas/63266 
correcao de Brand


https://www.youtube.com/watch?v=ZEljh4AqXYA&ab_channel=Celke 
 */ --}}